...
function revealStartupFallback() {
  ...
  notice.innerHTML = `
    <div style="max-width:520px">
      ...
      <p style="margin:0 0 18px;color:#b9bec9;line-height:1.55">L’introduction a été interrompue automatiquement. Relance l’interface pour réessayer.</p>
...
window.addEventListener("DOMContentLoaded", () => {
  window.setTimeout(revealStartupFallback, 12_000);
});
